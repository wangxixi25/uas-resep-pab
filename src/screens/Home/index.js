...
import { Box, FlatList, HStack, Heading, Image, Input, InputField, InputIcon, InputSlot, ScrollView, Text } from "@gluestack-ui/themed";
    ...
    <SafeAreaView>
      <ScrollView bgColor="white">
        <Box px={20} flex={1} bgColor="white">
          <Heading mt={60} fontSize={30} fontWeight="bold" color="#038861">Let’s Find Your Food</Heading>
          ...
          <Box marginTop={40}>
            <Image alt="cover" w={'100%'} height={200} rounded={20} source={{ uri: 'https://e0.pxfuel.com/wallpapers/52/830/desktop-wallpaper-food-background-food-food-recipes-food-menu-greek-food.jpg' }} />
          </Box>
          <Box mt={25}>
            <Text fontWeight="bold" fontSize={18} color="black">Categories</Text>

            <ScrollView horizontal mt={15} showsHorizontalScrollIndicator={false} >
              <HStack bgColor="#038861" space='md' p={14} rounded={15} marginEnd={10} height={55} width={150}>
                <Ionicons name="fast-food-outline" size={22} color="white" />
                <Text color="white">Heavy meal</Text>
              </HStack>
              <HStack bgColor="#038861" space='md' p={14} rounded={15} marginEnd={10} height={55} width={150}>
              <MaterialCommunityIcons name="food-apple-outline" size={22} color="white" />
          ...
          <Box mt={25} marginBottom={100}>
            <Text fontWeight="bold" fontSize={18} color="black" mb={20}>Recommendation</Text>
            <MasonryList
              numColumns={1}
              data={filteredNotes}
              renderItem={({ item }) => (
